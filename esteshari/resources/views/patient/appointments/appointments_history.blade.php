        ...
        @if($appointments->isEmpty())
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">No appointments exits.</li>
                </ul>
            </div>
        @else
        @foreach($appointments as $appointment)
                ...
                <div class="card mb-3">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Video Conference Meeting with <a href="#"  style="text-decoration: none">Dr. {{$appointment->user->name}}</a></h5>
