...
@section('content')
    ...
    <div class="container">
        <h3 class="form-title">Post-session Form View for Video Conference Meeting Session with: <a href="#" style="text-decoration: none">Dr. {{$physician->name}}</a> <span class="text-muted" style="font-weight: 400"> ({{ date('l, jS F Y', strtotime($session->slot_date)) }}, {{ substr($session->slot_time, 0, 5) }})</span></h3>
