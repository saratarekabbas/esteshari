                        ...
                        <div class="card">
                            <div class="rounded-top text-white d-flex flex-row"
                                ...
                                <div class="card-body p-4 text-black">
                                        ...
                                        <div class="p-4" style="background-color: #f8f9fa;">
                                            @if(isset($physician))
                                                @if(!is_null($physician->workExperience))
                                                    <p class="font-italic mb-1">As a highly skilled medical surgeon, I
                                                        have
                                                        ...
                                                        achieving optimal surgical outcomes, I have dedicated my career
                                                        to
                                                        enhancing the health and well-being of individuals through
                                                        advanced
                                                        ...
                                                        communication and a patient-centered approach, I strive to
                                                        alleviate
                                                        patients' concerns and create a comfortable environment
                                                        throughout
                                                        their surgical journey.
                                                        <br> <br>
                                                        My experience extends to managing complex cases, including
                                                        diagnosing surgical conditions, developing comprehensive
                                                        treatment
                                                        plans, and performing intricate surgical procedures with
                                                        precision
                                                        and utmost attention to detail. I am well-versed in utilizing
                                                        the
                                                        latest advancements in surgical technology and staying updated
                                                        on
                                                        emerging trends in the field.
                                                        <br> <br>
                                                        Beyond my technical expertise, I am deeply committed to
                                                        maintaining
                                                        the highest ethical standards in my practice. I prioritize
                                                        patient
                                                        ...
                                                        <br> <br>
                                                        With a passion for excellence and a dedication to lifelong
                                                        learning,
                                                        I continue to evolve as a medical surgeon, embracing new
                                                        challenges
                                                        and opportunities to make a positive impact on the lives of my
                                                        patients. It is my unwavering commitment to delivering
                                                        exceptional
                                                        surgical care that drives me to excel in this noble profession.
                                                    </p>
                                                @else
                                        ...
                                        <div class="p-4" style="background-color: #f8f9fa;">
                                            @if(isset($physician))
                                                @if(!is_null($physician->workExperience))
                                                    ...
                                                    <p class="font-italic mb-0"><span
                                                            style="font-weight: 600">Languages: </span>English, Arabic
                                                        and
                                                        Malay</p>
                                            ...
                                            @if(isset($physician))
                                                @if(!is_null($physician->workExperience))
                                                    <p class="font-italic mb-1"><span
                                                        ...
                                                        Medicine, Oxford University, United Kingdom (2010-2016),
                                                        Master's of
                                                        Endocrinology, Cairo University, Egypt (2006-2009), Bachelor's
                                                        of
                                                        Medicine, Universiti teknologi Malaysia, Malaysia (1993-1999)
                                                    </p>
                                            ...
                                            @if(isset($physician))
                                                @if(!is_null($physician->workExperience))
                                                    <p class="font-italic mb-1">
                                                        <span
                                                            style="font-weight: 600">Research Projects Conducted: </span>
                                                    ...
                                                    <p class="font-italic mb-1"><span
                                                        ...
                                                        <br>- Smith, J.,
                                                        Johnson, A., Anderson, B., et al. (2022). "A Comprehensive
                                                        Review of
                                                        Surgical Approaches in Treating Coronary Artery Disease."
                                                        Journal of
                                                        Cardiovascular Surgery, 45(3), 120-135
                                                        <br>- Brown, S., Roberts, L.,
                                                        Thompson, M., et al. (2021). "Long-term Neurodevelopmental
                                                        Outcomes
                                                        in Children Born Preterm: A Prospective Cohort Study."
                                                        Pediatrics,
                                                        138(5), e20210123.</p>
                                                    <br>
                                                    <p class="font-italic mb-1"><span style="font-weight: 600">Contributions: </span>
                                                        ...
                                                        "Advancements in Minimally Invasive Cardiac Surgery: A
                                                        Comparative
                                                        Study"
                                                        <br>- Panelist, Robotic Surgery Symposium, 2020:
                                                        "Robotic-Assisted
                                                        Orthopedic Surgeries: Current Trends and Future Directions"
                                                        <br>- Poster Presentation, American Society of Clinical Oncology
                                                        Annual Meeting, 2019: "Genetic Markers as Predictors of
                                                        Treatment
                                            ...
                                            @if(isset($physician))
                                                @if(!is_null($physician->workExperience))
                                                    ...
                                                    <p class="font-italic mb-1">
                                                        ...
                                                        <br>- Chairperson, Surgical Quality Improvement Committee, Ain
                                                        Shams
                                                        Hospital.
                                                        <br>- Chairperson, Surgical Quality Improvement Committee,
                                                        American
                                    ...
                                    <div class="mb-5">
                                        <p class="lead fw-normal mb-1">Healthcare Volunteering/Community Service
                                            Activities</p>
                                        <div class="p-4" style="background-color: #f8f9fa;">
                                            @if(isset($physician))
                                                @if(!is_null($physician->workExperience))
                                                    <p class="font-italic mb-1">
                                                        ...
                                                        <br>- Organizer, Annual Health Fair, offering health screenings
                                                        and
