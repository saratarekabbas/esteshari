        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    ...
                    <a href="{{route('patient.physicians_list.view')}}" class="btn btn-primary">Book an Appointment</a>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-1 text-center">
                        <a class="mb-3 mr-1" href="{{route('patient.physicians_list.view')}}" style="text-decoration: none">See All </a>
                    </div>
                    <div class="col-12">
                        <div class="row">
