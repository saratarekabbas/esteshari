...
<div class="col-md-6 form-floating">
    ...
    <label for="full_name">Degree Title</label>
</div>

<div class="col-md-4 form-floating">
    <input type="text" id="full_name" name="institute"
           placeholder="Enter Degree Title"
           class="form-control" required>
    <label for="full_name">Institute/University Name</label>
</div>
...
<div class="col-md-4 form-floating">
    ...
    <label for="nationality">Institute/University Location</label>
</div>

<div class="col-md-4 form-floating">
    <input type="date" id="date_of_birth" name="date_of_birth" class="form-control">
    <label for="date_of_birth">Year of Graduation</label>
</div>
<div class="form-group">
    <label for="identity_verification_files" class=" form-label">Medical Degree:</label>
    <input class="form-control" type="file" name="identity_verification_files"
           id="identity_verification_files" />
</div>

<button id="addQualificationBtn" type="button" class="btn btn-primary mt-3">Add another qualification</button>
