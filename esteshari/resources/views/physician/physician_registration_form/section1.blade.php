...
<div id="otherTitleContainer" class="form-group col-md-2" style="display: none;">
    <label for="otherTitle">Other designation:</label>
    <input type="text" placeholder="Other Designation" id="otherTitle" name="otherTitle"
           class="form-control">
</div>
...
<div class="col-md-6 form-group">
    ...
    <div class="form-check">
        <input type="checkbox" class="form-check-input" id="same_email" name="same_email">
        <label class="form-check-label" for="same_email">Use the same email address as my
            account</label>
    </div>
</div>
...
@php
    ...
    $isChecked = old('same_email') || (!old('email_address') && $userEmail);
@endphp
...
<div class="col-md-6 form-group">
    ...
    <input placeholder="Enter alternative email address" type="email" id="alternative_email_address"
           name="alternative_email_address" class="form-control">
</div>
...
<div class="form-group col-md-4 ">
    <label for="country_code">Mobile Number:</label>
    <div class="row">
            ...
            <div class="col-md-3">
                ...
                <script>
                    ...
                    countrySelect.addEventListener('change', function () {
                        ...
                        const countryCode = selectedOption.getAttribute('value');
...
<div class="form-group col-md-12">
    <label for="street_address">Address Line:</label>
    <input type="text" placeholder="Enter address line 1" id="street_address" name="street_address"
           class="form-control">
</div>

<div class="form-group col-md-12">
    <label for="street_address">Address Line 2:</label>
    <input type="text" placeholder="Enter address line 2" id="street_address2" name="street_address2"
           class="form-control">
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="text" placeholder="Enter state" id="state_province" name="state_province"
           class="form-control">
</div>
