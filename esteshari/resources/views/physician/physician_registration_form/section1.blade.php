...
<form class="form-content row g-3" action="{{ route('physician.registration.store')  }}" method="POST"
    ...
    <div class="col-md-2 form-floating">
        <select id="designation" name="designation" class="form-select @error('designation') is-invalid @enderror"
                required>
    ...
    <script>
        const titleSelect = document.getElementById('designation');
    ...
    <div class="col-md-6 form-floating">
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="same_email" name="same_email"
                {{ $isChecked ? 'checked' : '' }}>
            <label class="form-check-label" for="same_email">Use the same email address as my account</label>
        </div>
    </div>
    ...
    <div class="col-md-4 form-floating">
        <select id="nationality" name="nationality" class="form-select @error('nationality') is-invalid @enderror"
                required>
    ...
    <div class="form-group">
        <label for="identity_verification_files" class="form-label">Identity Verification Files (e.g., Passport,
            Identity Card, etc.):</label>
        <input class="form-control @error('identity_verification_files') is-invalid @enderror" type="file"
               name="identity_verification_files[]"
