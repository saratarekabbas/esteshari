...
<form action="{{ route('physician.registration.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container mt-4">
        <div class="form-group">
            ...
            <div id="otherTitleContainer" style="display: none;">
                <label for="otherTitle">Specify Other Title:</label>
    ...
    <div class="form-group">
        <div class="form-check">
            ...
            <label class="form-check-label" for="same_email">Use the same email address as my registration</label>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="email" id="alternative_email_address" name="alternative_email_address" class="form-control">
    </div>
