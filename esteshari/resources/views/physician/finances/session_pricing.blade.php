...
@section('content')
    <div class="container">
        <h3 class="form-title">Session Pricing</h3>
        <form class="form-content row g-3" action="{{ route('physician.session_pricing.update')  }}" method="POST"
              enctype="multipart/form-data">
            @csrf
            <div class="col-md-4 form-floating">
                <input type="text" id="cost" name="cost"
                       placeholder="Enter the price of your session"
                       class="form-control @error('cost') is-invalid @enderror"
                       value="{{ $pricing ? $pricing->cost : old('cost') }}" required>
                <label for="full_name">Session Pricing</label>
            ...
            <div class="col-md-4 form-floating">
                <input type="text" id="discountedCost" name="discountedCost"
                       placeholder="Enter the discounted price of your session"
                       class="form-control @error('discountedCost') is-invalid @enderror"
                       value="{{ $pricing ? $pricing->discountedCost : old('discountedCost') }}">
                <label for="discountedCost">Discounted Price</label>
                @error('discountedCost')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4 form-floating">
                ...
                <script>document.getElementById('currency').value = "{{ $pricing ? $pricing->currency : old('currency') }}";</script>
